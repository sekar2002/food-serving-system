...
public class JavaApplication3 extends pprice {
      ...
      void bill(int n,int m,int p)
    {
        ...
        System.out.println("pizza = "+sum1);
        System.out.println("Burger = "+sum2);
        System.out.println("Apple juice = "+n);
        System.out.println("Orange juice = "+m);
        System.out.println("Fried rice = "+p);
